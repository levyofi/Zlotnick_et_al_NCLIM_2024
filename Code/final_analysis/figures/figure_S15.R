...
dir.create("..//results//figure_S15", showWarnings = F)


figure_S15_facet_a <- function(){
  ...
  tiff(file=paste("..\\results\\figure_S15\\facet_a.tiff", sep = ""), width=6000, height=2500, res=300, compression="lzw")
...
figure_S15_facet_b <- function(){
  ...
  tiff(file=paste("..\\results\\figure_S15\\facet_b.tiff", sep = ""), width=6000, height=2500, res=300, compression="lzw")
...
figure_S15_facet_c <- function(){
  ...
  tiff(file=paste("..\\results\\figure_S15\\facet_c.tiff", sep = ""), width=6000, height=2500, res=300, compression="lzw")
