...
dir.create("..//results//figure_S12", showWarnings = F)


figure_S12_facet_a <- function(mat){
  ...
  tiff(file=paste("..\\results\\figure_S12\\facet_a.tiff", sep = ""), width=6000, height=2500, res=300, compression="lzw")
...
figure_S12_facet_b <- function(mat){
  ...
  tiff(file=paste("..\\results\\figure_S12\\facet_b.tiff", sep = ""), width=6000, height=2500, res=300, compression="lzw")
