...
dir.create("..//results//figure_5", showWarnings = F)

figure_5_facet_a <- function(){
  ...
  tiff(file=paste("..\\results\\figure_5\\facet_a.tiff", sep = ""), width=6000, height=2500, res=300, compression="lzw")
...
figure_5_facet_b <- function(){
  ...
  tiff(file=paste("..\\results\\figure_5\\facet_b.tiff", sep = ""), width=6000, height=2500, res=300, compression="lzw")
