...
dir.create("..//results//figure_S11", showWarnings = F)


figure_S11_facet_a <- function(){
  ...
  tiff(file=paste("..\\results\\figure_S11\\facet_a.tiff", sep = ""), width=6000, height=2500, res=300, compression="lzw")
...
figure_S11_facet_b <- function(file_name, growth_rate_mat, min, max, by){
  ...
  tiff(file=paste("..\\results\\figure_S11\\facet_b.tiff", sep = ""), width=6000, height=2500, res=300, compression="lzw")
...
figure_S11_facet_c <- function(file_name, growth_rate_mat, min, max, by){
  ...
  tiff(file=paste("..\\results\\figure_S11\\facet_c.tiff", sep = ""), width=6000, height=2500, res=300, compression="lzw")
...
figure_S11_facet_d <- function(mat){
  ...
  tiff(file=paste("..\\results\\figure_S11\\facet_d.tiff", sep = ""), width=5000, height=2500, res=300, compression="lzw")
...
figure_S11_facet_e <- function(mat){
  ...
  tiff(file=paste("..\\results\\figure_S11\\facet_e.tiff", sep = ""), width=5000, height=2500, res=300, compression="lzw")
